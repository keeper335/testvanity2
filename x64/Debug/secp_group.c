...
void secp256k1_ge_storage_cmov(secp256k1_ge_storage *r, secp256k1_ge_storage *a, int flag) {
...
void secp256k1_ge_set_all_gej_var(size_t len, secp256k1_ge *r, secp256k1_gej *a) {
